...
Dedico este livro à memória de meus ancestrais
...
Dostoiévski e o fetichismo da forma mercadoria
...
administração social em meio à (e contra a) democracia\footnote{\section{\texorpdfstring{
  Para estudos clássicos e detalhados sobre a Escola de Frankfurt,
  conferir Rolf Wiggershaus, \textbf{\emph{The Frankfurt School: Its
...
\textbf{1.3. Pressupostos dialógicos para o devir dialético}
...
\textbf{1.4. A polifonia como um momento da dialética negativa}
...
\textbf{A dialética polifônica de Fiódor Dostoiévski}

\textbf{2.1. No princípio eram a dicção -- e a contradição}
...
\textbf{2.2. Marx e a arquitetura do subsolo}
...
\textbf{2.3. A forma dinheiro escava as galerias subterrâneas}
...
\textbf{2.4. O Evangelho segundo o Capital:}
...
passu} neste nosso capítulo\footnote{Como Marx e a Teoria Crítica bem o
  ...
  \href{http://www.krisis.org/1999/manifesto-contra-o-trabalho}{\emph{http://www.krisis.org/1999/manifesto-contra-o-trabalho}}.
  Por fim, aqui está um link para uma página que compila os textos de
  Kurz e as entrevistas que o autor concedeu:
  \href{http://obeco.planetaclix.pt/robertkurz.htm}{\emph{http://obeco.planetaclix.pt/robertkurz.htm}}.
...
\textbf{2.5. Do leito do subsolo, a extração de mais-valia se reverte em
menos-valia}
...
é, à simonia
(\href{http://tradutor.sensagent.com/симония/ru-ru/}{симония}). Como o
...
\href{http://tradutor.sensagent.com/труд/ru-ru/}{труд} (\emph{trud},
labuta) e \href{http://tradutor.sensagent.com/любовь/ru-ru/}{любовь}
...
(\href{http://tradutor.sensagent.com/зверь/ru-ru/}{зверь},
...
O conteúdo em Dostoiévski como a cicatrização do espírito rumo à utopia?
...
\textbf{3.2. O cálculo utilitário à luz e às sombras da história}
...
\textbf{3.3. A utopia como degredo siberiano}
...
\textbf{3.3.1. História de proveta, socialismo de estufa}
...
\textbf{3.3.2. O socialismo siberiano da casa dos mortos}
...
\href{http://tradutor.sensagent.com/разум/ru-ru/}{разум} (\emph{razum};
...
\textbf{3.4. O prenúncio do Sermão da Estepe para além da montanha
nacional}
...
movimentos que a aparência pressupõe como antitéticos\footnote{Para uma
  ...
  Disponível em:
  \href{http://o-beco.planetaclix.pt/mctp.htm}{\emph{http://o-beco.planetaclix.pt/mctp.htm}}.
...
humanidade\footnote{Nesse sentido, Birgit Harress (1999) argumenta que,
  ...
  do \href{http://tradutor.sensagent.com/народ/ru-ru/}{\emph{народ}}
...
\section{Ivan Karamázov e a filosofia dostoievskiana da
história}\label{ivan-karamuxe1zov-e-a-filosofia-dostoievskiana-da-histuxf3ria}
...
\textbf{4.1. Se no princípio era o Verbo, como conjugar Suas aporias?}
...
\textbf{4.2. Para além do Sermão da Montanha}
...
\textbf{A utopia como cicatrização do espírito}
...
\textbf{5.2. Só existe uma ação verdadeiramente niilista: o
...
\textbf{5.3. A mão que fere é a mesma mão que pode curar}\footnote{``The
...
с\href{http://tradutor.sensagent.com/тяжело/ru-ru/}{о}\href{http://tradutor.sensagent.com/страдать/ru-ru/}{страдать}
...
\textbf{5.6. Da queda à reconciliação?}
...
\href{http://tradutor.sensagent.com/истина/ru-ru/}{истина}
(\emph{istina}):
...
HACKEL, Sergei. ``F.M. Dostoevsky (1821-1881): prophet manqué?'' In:
...
MARTINSEN, Deborah. ``Ingratitude and the Underground''\emph{.} In:
...
NIETZSCHE, Friedrich. \emph{Escritos sobre história.} Tradução de Noéli
...
WALICKI, Andrzej. \emph{A History of Russian Thought from the
Enlightenment to Marxism}. Stanford: Stanford University Press, 1979.
