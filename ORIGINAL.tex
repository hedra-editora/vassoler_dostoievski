...
\hedramarkboth{Parte I - Tese}{}

%\chapter{Dostoiévski e o fetichismo da forma mercadoria}

\begin{chapquote}{Mikhail Bakhtin, \emph{Problemas da poética de Dostoiévski}\footnote{Tradução
  de Paulo Bezerra. Rio de Janeiro: Forense Universitária, 2008, p. 51.}}
\noindent\scriptsize{Parece que todo aquele que penetra no labirinto do romance polifônico
não consegue encontrar a saída e, obstaculizado por vozes particulares,
não percebe o todo.}
\end{chapquote}


\begin{chapquote}{Homem do subsolo, \emph{Memórias do subsolo}\footnote{Tradução de Boris Schnaiderman.
São Paulo: Editora 34, 2004, p. 19;
  pp. 19-20; p. 20.}}
\noindent\scriptsize{Quanto mais consciência eu tinha do bem e de tudo o que é ``belo e
...
\begin{chapquote}{Karl Marx, \emph{O capital}\footnote{Tradução de
  Flávio Kothe. São Paulo: Nova Cultural, 1998, p. 76.}}
\noindent\scriptsize{O reflexo religioso do mundo real somente pode desaparecer quando as
...
\vspace*{\fill}
\begin{chapquote}{\emph{Apocalipse}, 6, 10}
\noindent\scriptsize{E clamavam em alta voz, dizendo: ``Até quando tu, que és o Senhor, o
Santo, o Verdadeiro, ficarás sem fazer justiça e sem vingar o nosso
sangue contra os habitantes da terra?}
\end{chapquote}

\begin{chapquote}{Clérigo Tíkhon, \emph{Os demônios}\footnote{Tradução de Paulo Bezerra.
  São Paulo: Editora 34, 2004, p. 662.}}
\noindent\scriptsize{O ateísmo completo está no penúltimo degrau da fé mais perfeita (se
subirá esse degrau já é outra história).}
\end{chapquote}

\begin{chapquote}{Homem ridículo, ``O sonho de um homem ridículo''\footnote{Tradução
de Vadim Nikitin. São Paulo: Editora 34, 2003, pp. 121-122.}}
\noindent\scriptsize{Eu vi a verdade, eu vi e sei que as pessoas podem ser belas e felizes,
sem perder a capacidade de viver na terra. Não quero e não posso
acreditar que o mal seja o estado normal dos homens.}
\end{chapquote}
...
\begin{chapquote}{\emph{Dostoiévski, Dresden, 17 de agosto de 1870.\\
\hspace*{\fill}Carta para a sobrinha Sofia Aleksandrovna}\footnote{\emph{Dostoiévski:
  correspondências, 1838-1880}. Tradução de Robertson Frizero. Porto
  Alegre: 8Inverso, 2011, p. 185.}}
\noindent\scriptsize{Sem a guerra, as pessoas tornam-se torpes em suas riquezas e conforto e
...
\begin{chapquote}{\emph{Clérigo Tíkhon, Os demônios}\footnote{São Paulo: Editora 32, 2004,
  p. 662.}}
\noindent\scriptsize{O ateísmo completo está no penúltimo degrau da fé mais perfeita (se
subirá esse degrau já é outra história).}
\end{chapquote}
