...
<<<<<<< HEAD
  Humanas da \versal{USP} entre 22/08/12 e 29/11/12.}, orientador de minha
...
<<<<<<< HEAD
  ...
  Letras Modernas, \versal{FFLCH/USP}, 1993.} e ``Dostoiévski: criação, poesia e
=======
  (orgs), \emph{A~questão da modernidade}. Caderno 1, Departamento de
...
Acabará triunfando, atingirá a liberdade... (\versal{DOSTOIÉVSKI}, 2004, pp.
685-686).
...
demais gêneros, (...) como algo em devir, como um processo'' (\versal{LUKÁCS},
...
``substituir com sua própria voz a voz de outra pessoa'' (\versal{BAKHTIN}, 2008,
=======
flagelar-se. O~diálogo velado permite ao protagonista, então,
...
Deixai"-me tomar fôlego...'' (\versal{IDEM}, p. 17). Em seu monólogo dialogado, o
...
um inseto (...) (\versal{DOSTOIÉVSKI}, 2004, p. 18).
...
\textbf{(iv)} Para nós, homens de pensamento (...) (\versal{IDEM}, p. 22).
...
ignobeizinhos? Pois que vos sintais mal (...) (\versal{IDEM}, pp. 27-28).
...
vez...'' {[}grifo meu{]} (\versal{IDEM}, p. 53). Para a dialética de Dostoiévski
...
jantar. Eu disse apenas para se saber... Por favor...'' (\versal{IDEM}, p. 80).
...
sabe que mulher ela é!... (\versal{IDEM}, p. 134)
\end{quote}
...
invejoso,} um ódio por ela... (\versal{IDEM}, p. 141).
\end{quote}
...
nenhuma outra!... (\versal{IDEM}, p. 108)
\end{quote}
...
O fato é que eu... perverti todos eles!'' (\versal{DOSTOIÉVSKI}, 2003, pp.
115-116)
