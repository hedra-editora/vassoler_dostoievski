...
Se, na primeira parte do livro, procuramos apresentar Dostoiévski como um
...
inteligível, da essência, e não do ser empírico, dos homens como eles
...
arremessar o escravo contra o senhor, de modo que o senhor também comece
...
nosso \mbox{(anti-)herói}, outrora um assessor"-colegial\footnote{O professor
  ...
  administração civil, no regime czarista'' (\versal{IDEM}, p. 17).},
...
\begin{quote}
\versal{D'} = \versal{D} + \versal{$\Delta$D}, ou seja, igual à soma de dinheiro originalmente adiantado
...
\smallskip
\hspace*{\fill}--- Homem ridículo, \emph{O sonho de um homem ridículo}\footnotemark
\end{minipage}
\footnotetext{Tradução
...
grandes obras (\versal{FRANK}, 2002, p. 345)\footnote{Victor Terras (1985), em
  ...
  o sentido artístico da escatologia em Dostoiévski: ``A acusação de que
...
às últimas consequências a ideia de que a nova versão da guerra de todos
...
coisas\footnote{Em ``Dostoevsky versus Max Stirner'', Nadine Natov
  ...
  mim'', Stirner escreve: ``Que Deus se preocupe com o que é divino;
...
socialismo e capitalismo, poderia enredar os homens e as mulheres à
...
verdade? Mas eis o que é surpreendente: por que sucede que todos esses
...
enredou ao ``chalé das delícias'' do lascivo Totski. Míchkin lhe
...
se perguntar como as personagens de Dostoiévski devem ser governadas,
...
estamos chamando de (des)vanta-
gem quintessencial? Dostoiévski narrou uma
...
sentido, refere"-se ao movimento centrípeto do eu que retorna,
...
ridículo é um descendente direto do homem do subsolo, o que o
...
a ideia da ``salvação por meio do sofrimento'', tudo isso preocupou Dostoiévski em
...
espirituais'' (\versal{DOSTOIÉVSKI} apud \versal{NEUHÄUSER}, 1993, p. 187). O~receio de
...
crianças do Sol e então o homem ridículo ---, a comunicação é espontânea
...
existir como consciência de si e para si ---, caso se queira emancipatória,
...
antídotos para a modernidade por meio de soluções anacrônicas, idílicas
...
universal divino. Se me oponho, em minha liberdade abstrata, ao
...
curar, como o punho cerrado do soco pode se distender de modo a oferecer a
...
\begin{quote}
ao longo de sua vida após o exílio, o autor insiste que o progresso
...
Em discussão com o ensaio de Dostoiévski ``Socialismo e
...
uma unidade, e de que o homem, sendo espírito, contém a essencialidade e a
...
\begin{quote}
Uma paz prolongada sempre dá vazâo à crueldade, à covardia, ao egoísmo
